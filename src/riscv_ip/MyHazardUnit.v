...
module HazardUnit (
    ...
    always @(*) begin
        // Forward A
        if ((RegWriteM == 1'b1) && (ResultSrcM0 == 1'b0) && (RdM != 5'b0) && (RdM == Rs1E))
            ForwardAE = 2'b10; // Forward from Memory Stage (ALU results only)
    ...
    // If logic in E is a Load, and it writes to a register that D reads, then stall
